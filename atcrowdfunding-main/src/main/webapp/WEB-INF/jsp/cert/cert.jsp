        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <button type="button" class="btn btn-primary" style="float:right;" onclick="window.location.href='${APP_PATH}/cert/toAddPage.htm'"><i class="glyphicon glyphicon-plus"></i> 新增</button>
                    <br>
                    <hr style="clear:both;">
...
<script type="text/javascript">
    ...
    function parseJsonToUserList(result) {
        ...
        $.each(userList,function (i,n) {
            ...
            userListHtml+='<td><input deleteId='+n.id+' id="aCheckbox" class="aCheckbox" type="checkbox"></td>';
            userListHtml+='<td>'+n.name+'</td>';
            userListHtml+='<td>';
            userListHtml+=' <button type="button" onclick="window.location.href=\''+'${APP_PATH}/cert/toUpdatePage.htm?id='+n.id+'\'" class="btn btn-primary btn-xs"><i class=" glyphicon glyphicon-pencil"></i></button>';
            userListHtml+=' <button type="button" onclick="doDelete('+n.id+',\''+n.name+'\')" class="btn btn-danger btn-xs"><i class=" glyphicon glyphicon-remove"></i></button>';
            userListHtml+='</td>';
            userListHtml+='</tr>';
        });
            ...
            $.ajax({
                ...
                success:function (result) {
                    ...
                    if (result.code==100){
                        ...
                        window.location.href="${APP_PATH}/cert/toCertPage.htm";
                    } else{
                        layer.msg(result.message,{icon:0,shift:6});
                    }
                },
    ...
    $("#batchDeleteBtn").click(function () {
        if ($(".aCheckbox:checked").length==0){
            layer.msg("请选择要删除的资质信息！", {time:1500, icon:0, shift:6});
            return false;
        }
        var id="";
        ...
        var listLoading;
        layer.confirm("确认删除账户这些资质信息吗？",  {icon: 3, title:'提示'}, function(cindex){
            layer.close(cindex);
            $.ajax({
                url:"${APP_PATH}/cert/"+id+".do",
                data:{
