    ...
    <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            <ol class="breadcrumb">
                ...
                <li><a href="${APP_PATH}/advertisement/toAdvertisementPage.htm">数据列表</a></li>
                ...
                <div class="panel-body">
                    <form id="updateForm" role="form">
                        <div class="form-group">
                            <label for="fname">广告描述</label>
                            <input type="text" value="${advertisement.name}" class="form-control" id="fname" placeholder="请输入广告描述">
                            <p id="nameTip"  class="help-block label label-warning"></p>
                        </div>
                        <div class="form-group">
                            <label for="furl">广告URL</label>
                            <input type="text" value="${advertisement.url}" class="form-control" id="furl" placeholder="请输入广告url地址">
                            <p id="nameTip"  class="help-block label label-warning"></p>
                        </div>
...
<script type="text/javascript">
    ...
    $("#updateBtn").click(function () {
        ...
        var listLoading;
        $.ajax({
            url:"${APP_PATH}/advertisement/${advertisement.id}.do",
            data:{
                "name":fname.val(),
                "url":furl.val(),
                "_method":"put"
