    ...
    <div class="row clearfix">
        <div class="col-sm-3 col-md-3 column">
                    ...
                    <div class="thumbnail" style="    border-radius: 0px;">
                        ...
                        <div class="caption" style="text-align:center;">
                            ...
                            <c:choose>
                                ...
                                <c:otherwise>
                                    <span class="label label-danger" style="cursor:pointer;" onclick="window.location.href='${APP_PATH}/member/choseApply.htm'">未实名认证</span>
                                </c:otherwise>
                            </c:choose>
            ...
            <div class="list-group">
                ...
                <div class="list-group-item " style="cursor:pointer;" onclick="window.location.href='${APP_PATH}/member/toMyctrowdfundingPage.htm'">
