...
<div class="container theme-showcase" role="main">
    ...
    <div style="padding-top:10px;">
        ...
        <button type="button" id="accttypeBtn" class="btn btn-danger btn-lg btn-block">认证申请</button>
    </div> <!-- /container -->
    <!-- /END THE FEATURETTES -->
    ...
    <script>
        ...
        $("#accttypeBtn").click(function () {
            if ($(".seltype").length==0){
                layer.msg("请选择账户类型！", {time:1500, icon:0, shift:6});
            }else {
                $.ajax({
                    ...
                    success:function (result) {
                        ...
                        if (result.code==100){
                            ...
                            window.location.href="${APP_PATH}/member/toApplyPage.htm";
                        } else{
