                ...
                <div class="panel-body">
                    <form id="updateForm" role="form">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" value="${permission.name}" id="fname" placeholder="请输入许可名称">
                            <p id="loginacctTip" class="help-block label label-warning"></p>
                        </div>
                        <div class="form-group">
                            <label for="furl">许可URL</label>
                            <input type="text" class="form-control" value="${permission.url}" id="furl" placeholder="请输入许可URL">
                        ...
                        <div class="form-group">
                            ...
                            <div class="alert alert-danger" role="alert" style="width: 250px; font-size: 18px">
                                <span id="showicon" class="${permission.icon}" aria-hidden="true">  请选择许可图标</span>
                            </div>
                            <select style="width: 350px" type="radio"  value="${permission.icon}" class="form-control" id="ficon" placeholder="请选择许可图标">
...
<script type="text/javascript">
    ...
    $("#updateBtn").click(function () {
        ...
        var listLoading;
        $.ajax({
            url:"${APP_PATH}/permission/${permission.id}.do",
            data:{
                "name":fname.val(),
                "icon":ficon.val(),
                "url":furl.val(),
    ...
    $("#resetBtn").click(function () {
        ...
        $("#showicon").addClass("${permission.icon}");
    });
